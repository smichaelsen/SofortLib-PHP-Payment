...
<transactions />';
	...
	public function testPost () {
		$MockPost = $this->getMock( 'SofortLibHttpSocket', array( '_socketRequest' ),array(self::$testapi_url, 'gzip', 'http://www.sofort.com') );

		$MockPost->setConfigKey(self::$configkey);

		$MockPost->expects($this->any())
					->method('_socketRequest')
		...
		$this->assertEquals('<errors><error><code>000Test</code><message></message></error></errors>', $MockPost->post('data'));
	}


	public function testPostViaSocket() {
		$url = 'https://www.sofort.com/notAvailable';
